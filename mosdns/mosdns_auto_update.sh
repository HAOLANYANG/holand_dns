...
wget --no-check-certificate https://ghproxy.com/https://raw.githubusercontent.com/HAOLANYANG/holand_dns/main/mosdns/rules/universal.txt -O /etc/mosdns/data/universal.txt
